  ...
  switch (name.toLowerCase()) {
    ...
    case 'bank charge':
      return Icon(FontAwesomeIcons.fileInvoiceDollar,
          color: GColors.textColor, size: size0);
    case 'cash':
      return Icon(FontAwesomeIcons.moneyBill,
          color: GColors.textColor, size: size0);
    case 'charity':
      return Icon(FontAwesomeIcons.circleDollarToSlot,
          color: GColors.textColor, size: size0);
    case 'childcare':
      return Icon(FontAwesomeIcons.baby, color: GColors.textColor, size: size0);
    case 'clothing':
      return Icon(FontAwesomeIcons.shirt,
          color: GColors.textColor, size: size0);
    case 'credit card':
    ...
    case 'eating out':
      return Icon(FontAwesomeIcons.utensils,
          color: GColors.textColor, size: size0);
    case 'education':
      return Icon(FontAwesomeIcons.school,
          color: GColors.textColor, size: size0);
    case 'entertainment':
      return Icon(FontAwesomeIcons.champagneGlasses,
          color: GColors.textColor, size: size0);
    case 'gifts':
    ...
    case 'groceries':
      return Icon(FontAwesomeIcons.basketShopping,
          color: GColors.textColor, size: size0);
    case 'grooming':
      return Icon(FontAwesomeIcons.scissors,
          color: GColors.textColor, size: size0);
    case 'health':
      return Icon(FontAwesomeIcons.suitcaseMedical,
          color: GColors.textColor, size: size0);
    case 'holiday':
      return Icon(FontAwesomeIcons.plane,
          color: GColors.textColor, size: size0);
    case 'home repair':
      return Icon(FontAwesomeIcons.hammer,
          color: GColors.textColor, size: size0);
    case 'household':
      return Icon(FontAwesomeIcons.toiletPaper,
          color: GColors.textColor, size: size0);
    case 'insurance':
      return Icon(FontAwesomeIcons.carBurst,
          color: GColors.textColor, size: size0);
    case 'investment':
      return Icon(FontAwesomeIcons.scaleUnbalanced,
          color: GColors.textColor, size: size0);
    case 'loan':
    ...
    case 'mortgage':
      return Icon(FontAwesomeIcons.house,
          color: GColors.textColor, size: size0);
    case 'others':
...
Icon getIncomeIcon(String name, [double? size]) {
  ...
  switch (name.toLowerCase()) {
    case 'bonus':
      return Icon(FontAwesomeIcons.gift, color: GColors.textColor, size: size0);
    case 'investment':
      return Icon(FontAwesomeIcons.scaleUnbalancedFlip,
          color: GColors.textColor, size: size0);
    case 'loan payment':
      return Icon(FontAwesomeIcons.fileInvoiceDollar,
          color: GColors.textColor, size: size0);
    ...
    case 'others':
      return Icon(FontAwesomeIcons.dollarSign,
          color: GColors.textColor, size: size0);
    case 'salary':
      return Icon(FontAwesomeIcons.moneyCheckDollar,
          color: GColors.textColor, size: size0);
    case 'deposit':
      return Icon(FontAwesomeIcons.moneyCheck,
          color: GColors.textColor, size: size0);
